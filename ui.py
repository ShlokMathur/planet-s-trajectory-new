...
# Load data
planet_info = pd.read_csv(r'C:\Users\Shlok Mathur\Desktop\practice_codes\Planets\modified_planets.csv')
coordinates = pd.read_csv(r'C:\Users\Shlok Mathur\Desktop\practice_codes\Planets\planetary_coordinates_2025_01_16.csv')
